...
(
    id_cliente     DECIMAL(15,0)  NOT NULL,      --Identificacion de Cliente.
    tp_documento   VARCHAR       NOT NULL,      --Tipo de documento de Cliente (1->CC / 2->CE / 3->Pasaporte) 
    ...
    mail_cliente   VARCHAR       NOT NULL,      --Email Cliente.
    pass_cliente   VARCHAR(12)   NOT NULL,      --Clave. 
    tel_cliente    DECIMAL(10)   NOT NULL,      --Telefono Cliente. 
    cto_emerg      DECIMAL(10)   NOT NULL,      --Contacto de emergencia 
    usr_insert     VARCHAR,
...
(
    id_tpservicio     DECIMAL(1,0)  NOT NULL,    --Identificador del tipo servicio
    nom_tpservicio    VARCHAR       NOT NULL,     --Nombre del tipo de servicio
    usr_insert        VARCHAR,  
    fec_insert        TIMESTAMP     WITHOUT TIME ZONE,
    usr_update        VARCHAR, 
    fec_update        TIMESTAMP     WITHOUT TIME ZONE,
    PRIMARY KEY(id_tpservicio)
);

CREATE TABLE Servicios
(
    id_servicio       DECIMAL(2,0)  NOT NULL,     --Identificador de servicio
    id_tpservicio     DECIMAL(1,0)  NOT NULL,     --Identificador del tipo de servicio
    ...
    FOREIGN KEY (id_tpservicio)  REFERENCES Tipo_Servicio(id_tpservicio)     
);
...
(  
    ...
    tipo_cuenta         VARCHAR       NOT NULL,         --Tipo de Cuenta proveedor (1->Cuenta de ahorro / 2->Cuenta de corriente) 
