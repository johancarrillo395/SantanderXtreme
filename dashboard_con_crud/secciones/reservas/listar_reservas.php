...
$sentencia =  $conexion->query('SELECT id_cliente,id_documentocl,nom_cliente,ape_cliente,nac_cliente,mail_cliente,pass_cliente, tel_cliente,cto_emerg FROM Clientes ORDER BY 1');
                    ...
                    <div class="table-responsive">        
                        ...
                        <tbody>
                            ...
                            <td><?php echo $clien->id_cliente ?></td>
							              <td><?php echo $clien->id_documentocl ?></td>
