...
$sentencia =  $conexion->query('SELECT id_servicio,nom_servicio,dispo_servicio,deta_servicio,precio_servicio,idtp_servicio FROM Servicios ORDER BY 1');
                ...
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <tbody>
                            ...
                            <td><?php echo $reser->nom_servicio ?></td>
                            <td><?php echo $servi->dispo_servicio    ?><td>
                            <td><?php echo $servi->deta_servicio ?></td>
                            <td><?php echo $servi-> precio_servicio ?></td>
                            <td><?php echo $servi-> idtp_servicio ?></td>
